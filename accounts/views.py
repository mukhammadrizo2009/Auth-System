...
from accounts.serializers import RegisterSerializer, UserSerializer, LoginSerializer, ProfileSerializer, PasswordChangeSerializer
...
class AdminPanelView(APIView):
    ...
    def get(self, request: Request) -> Response:
        return Response("Xush kelibsiz AdminJon!")